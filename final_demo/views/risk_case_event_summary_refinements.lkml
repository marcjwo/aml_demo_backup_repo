...
#     type: string
#     sql:CASE
#               WHEN ${predictions.risk_period_end_raw}  IS NOT NULL AND ${risk_case_event_summary.event_time_raw} IS NOT NULL THEN "Present in both"
#               WHEN ${predictions.risk_period_end_raw} IS NOT NULL
#             AND  ${predictions.risk_case_event_summary.event_time_raw} IS NULL THEN "Present in AML AI"
#               WHEN ${predictions.risk_period_end_raw} IS NULL AND ${risk_case_event_summary.event_time_raw} IS NOT NULL THEN "Present in rule based only"
#           END
#         ;;
#   }
...
#     sql: CASE
#           WHEN ${predictions.risk_period_end_raw} IS NOT NULL
#             AND ${predictions.risk_case_event_summary.event_time_raw} IS NULL THEN RAND()
#           WHEN ${predictions.risk_period_end_raw} IS NOT NULL AND ${risk_case_event_summary.event_time_raw} IS NOT NULL THEN RAND()
#           END;;
#   }

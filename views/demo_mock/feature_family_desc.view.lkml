...
view: feature_family_desc {
  derived_table: {
    sql:
      SELECT
        'Unusual wire debit activity' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual wire credit activity' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual wire credit and debit activity' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual round value wire activity' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual card debit activity' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual monthly proportions of different credit and debit transaction types' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual monthly proportions of different debit transaction types' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual monthly proportions of different credit transaction types' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual counterparty activity' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual debit activity' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual cross border wire activity' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual credit activity' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual cash debit activity' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual cash credit activity' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual cash credit and debit activity' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual rapid movement of funds' AS feature_family_name,
      ...
      UNION ALL
      SELECT
        'Unusual cash and wire inactivity' AS feature_family_name,
  ...
  dimension: feature_family_name {
    label: "Feature Family"
    primary_key: yes
    type: string
    sql: ${TABLE}.feature_family_name ;;
  }

...
view: explainability__attributions {
  ...
  measure: _attribution {
    ...
    link: {
      ...
      url: "/dashboards/15?Feature+Family={{ feature_family_desc.feature_family_name._value }}&Full+Name={{ _filters['party_fullname_mapping.full_name'] | url_encode }}&Risk+Period+End+Month={{ _filters['explainability.risk_period_end_month'] | url_encode }}"
    }
  }
}
